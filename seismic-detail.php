<?php include("./data/data-seismic-detail.php"); ?>
<!DOCTYPE html>
<html lang="en">
         ...
         <div class="row">
                     ...
                     <div class="col-md-12">
                        <div class="slider-hero">
                           <div class="featured-carousel owl-carousel">
                              <?php for ($i = 0; $i < count($product_detail_main); $i++) {
                              ?>
                              <div class="item">
                                 <div class="work">
                                    <div class="img d-flex align-items-center justify-content-center"
                                       style="background-image: url(<?php echo $product["image"][$i] ?>);">
                           ...
                           <div class="my-5 text-center">
                              <ul class="thumbnail">
                                 <?php for ($i = 0; $i < count($product_detail_main); $i++) {
                                 ?>
                                 <li><a href="#"><img src="<?php echo $product["image"][$i] ?>" alt="Image"
            ...
            <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
               <div class="about_box" style="padding-left: 20px;">
                  <?php //for ($i = 0; $i < count($product_detail_main); $i++) {
                  ?>
                  <h3> <?php //echo $product["item"] 
                        ?> </h3>
                  <?php // }
                  ?>
                  <?php echo $product_detail_main["details"][0]
                  ?>
               </div>
            </div>
         </div>
