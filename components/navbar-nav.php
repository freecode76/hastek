                        ...
                        <div class="limit-box">
                            <nav class="main-menu">
                                <ul class="menu-area-main">
                                    <li <?php if($_SERVER['SCRIPT_NAME']=="/src/index.php") { ?> class="active"
                                        <?php   }  ?>><a href="index.php">Home</a></li>
                                    <li <?php if($_SERVER['SCRIPT_NAME']=="/src/about.php") { ?> class="active"
                                    ...
                                    <li>
                                        ...
                                        <ul>
                                            ...
                                            <ul class="d-flex flex-column ">
                                                <li><a href="#" class="item-dropdown"
                                                        style="font-size: 16px;">Product</a></li>
                                                <li><a href="#" class="item-dropdown"
                                                        style="font-size: 14px; font-weight: 400;">Spring Vibration
                                                        Isolators</a></li>
                                                <li><a href="#" class="item-dropdown"
                                                        style="font-size: 14px; font-weight: 400;">Isolation Mounts &
                                                        Pads</a></li>
                                                <li><a href="#" class="item-dropdown"
                                                        style="font-size: 14px; font-weight: 400;">Vibration Isolation
                                                        Hangers</a></li>
                                            </ul>
                                        </ul>
                                    </li>
